...
import FOStaticDateField from 'components/FOStaticDateField';
...
const ReduxDateSelector = observer(({ dateField, label, onClose, staticPicker, detailed, hideSkipButton, clearable = false }: IReduxDateSelectorProps) => {
      ...
      <Grid item xs={12}>
        <Field
          ...
          renderInput={((props) => {
            ...
            if (props.value) {
              return (
                <Button {...props} color='primary' className={classes.selectedDate} onClick={setDialogOpen}>
            ...
            return (
              <IconButton {...props} color='primary' onClick={setDialogOpen}>
                <EventAvailableOutlined />
              </IconButton>
            );
          })}
