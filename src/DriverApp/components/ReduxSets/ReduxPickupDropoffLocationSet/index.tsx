...
const ReduxPickupDropoffLocationSet = observer(({
  change, pickupLocationField, downloadPastLocations, step, extraSteps = [],
  pickupLocationFieldValue, dropoffLocationFieldValue, dropoffLocationField, recentDropoffLocations, programmaticFormSubmit,
  pagination, downloadNextResults, recentPickupLocations, pastLocationLoading, showNearBy, showSkip, pickupLocationAddonStart, dropoffLocationAddonStart
